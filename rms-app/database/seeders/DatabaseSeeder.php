...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        SiteSettings::updateOrCreate(
            ['id' => 1],
            [
                'website_name' => config('restaurant.name', 'Your Restaurant'),
                'website_tagline' => config('restaurant.tagline'),
                ...
                'hours_json' => config('restaurant.hours'),
                'about_title' => data_get(config('restaurant.about'), 'title'),
                'about_us' => data_get(config('restaurant.about'), 'text'),
                'content_json' => config('restaurant.content'),
                'guest_rating' => config('restaurant.guest_rating', '4.8'),
            ]
        );
